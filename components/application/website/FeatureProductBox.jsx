...
const FeatureProductBox = ({ product }) => {
  ...
  return (
    <div className=" w-full rounded-2xl md:min-h-110 min-h-90 flex flex-col justify-between hover:shadow-xl transition-all duration-200 overflow-hidden">
      <Link href={''}><Image
        ...
        className="w-full md:h-90  h-50 rounded-2xl object-cover"
      />
      <div className="p-3">
